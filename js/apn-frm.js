...
$("input:radio[name=subs_type_rad]").change(function() {
    var int_val = $(this).val()==='p' ? '1' : '2';
    $('#subs_type').val(int_val);
});

$("input:radio[name=subs_pos_fam_rad]").change(function() {
    var int_val = $(this).val()==='HHHead' ? '1' : '2';
    $('#subs_pos_fam').val(int_val);
});

$("input:radio[name=oc_fam_hd_rad]").change(function() {
    var str = $(this).attr('id');
    var int_val = str.replace('oc_fam_hd_rad', '');
    $('#oc_fam_hd').val(int_val);
});
$("input:radio[name=oc_subsc_rad]").change(function() {
    var str = $(this).attr('id');
    var int_val = str.replace('oc_subsc_rad', '');
    $('#oc_subsc').val(int_val);
});

$("input:radio[name=schoolgoing_labour_rad]").change(function() {
    var str = $(this).attr('id');
    var int_val = str.replace('schoolgoing_labour_rad', '');
    $('#schoolgoing_labour').val(int_val);
});
...
$("input:radio[name=service_model_rad]").change(function() {
    var rad_inpt    = $(this).attr('id');    
    var inpt        = $(this).val(); 
    var int_val     = rad_inpt.replace('service_model_rad', '');
